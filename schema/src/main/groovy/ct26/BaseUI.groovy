...
abstract class BaseUI implements IOEntity {
    String name
...
//    @Deprecated boolean getText(){ useFont }
//    @Deprecated void setText(boolean text) { useFont = text }

    @Deprecated String getText_font_1(){ styleName }
    @Deprecated void setText_font_1(String text_font_1){ styleName = text_font_1}

    @Deprecated String getText_font_2(){ fontName }
    @Deprecated void setText_font_2(String text_font_1){ fontName = text_font_1}

    @Deprecated Color getText_color() { fontColor }
    @Deprecated void setText_font_2(Color text_color){ fontColor = text_color}
}
