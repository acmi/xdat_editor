...
class Window extends BaseUI implements Iterable<BaseUI> {
    ...
    Window write(OutputStream output) {
        ...
        use(IOUtil) {
            ...
            output.writeInt(alwaysFullAlpha)
    ...
    @Deprecated int getUnk108(){ alwaysFullAlpha }
    @Deprecated void setUnk108(int unk108){ alwaysFullAlpha = unk108}
}
