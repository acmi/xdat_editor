...
class ItemWindow extends DefaultProperty {
    ...
    ItemWindow read(InputStream input) {
        ...
        use(IOUtil) {
            ...
            unk1181 = input.readInt()
            unk1182 = input.readInt()
            unk1183 = input.readInt()
            unk1184 = input.readInt()
            unk1185 = input.readString()
    ...
    ItemWindow write(OutputStream output) {
        ...
        use(IOUtil) {
            ...
            output.writeInt(unk1181)
            output.writeInt(unk1182)
            output.writeInt(unk1183)
            output.writeInt(unk1184)
            output.writeString(unk1185)
