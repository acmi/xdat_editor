...
class CheckBox extends DefaultProperty {
    ...
    @Deprecated
    int getUnk102() { IOUtil.boolToInt(checked) }

    @Deprecated
    void setUnk102(int unk102) { this.checked = IOUtil.intToBool(unk102) }

    @Deprecated
    int getUnk103() { IOUtil.boolToInt(leftAligned) }

    @Deprecated
    void setUnk103(int unk103) { this.leftAligned = IOUtil.intToBool(unk103) }
