...
class SliderCtrl extends DefaultProperty {
    ...
    SliderCtrl write(OutputStream output) {
        ...
        use(IOUtil) {
            output.writeInt(isVerticalType)
    ...
    @Deprecated int getUnk100() { isVerticalType }
    @Deprecated void setUnk100(int unk100) { this.isVerticalType = unk100 }
