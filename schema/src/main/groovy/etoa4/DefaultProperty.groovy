...
abstract class DefaultProperty implements UIEntity {
    ...
    @Deprecated
    String getSuperName() { extendsName }

    @Deprecated
    void setSuperName(String superName) { this.extendsName = superName }

    @Deprecated
    int getUnk2() { IOUtil.boolToInt(alwaysOnTop) }

    @Deprecated
    void setUnk2(int unk2) { this.alwaysOnTop = IOUtil.intToBool(unk2) }

    @Deprecated
    int getUnk3() { IOUtil.boolToInt(alwaysOnBack) }

    @Deprecated
    void setUnk3(int unk3) { this.alwaysOnBack = IOUtil.intToBool(unk3) }

    @Deprecated
    int getUnk31() { IOUtil.boolToInt(equalToParentSize) }

    @Deprecated
    void setUnk31(int unk31) { this.equalToParentSize = IOUtil.intToBool(unk31) }

    @Deprecated
    String getUnk4() { parentName }

    @Deprecated
    void setUnk4(String unk4) { this.parentName = unk4 }

    @Deprecated
    String getUnk5() { preOrder }

    @Deprecated
    void setUnk5(String unk5) { this.preOrder = unk5 }

    @Deprecated
    String getUnk6() { postOrder }

    @Deprecated
    void setUnk6(String unk6) { this.postOrder = unk6 }

    @Deprecated
    int getUnk6_() { IOUtil.boolToInt(anchored) }

    @Deprecated
    void setUnk6_(int unk6_) { this.anchored = IOUtil.intToBool(unk6_) }

    @Deprecated
    int getUnk7() { IOUtil.boolToInt(relativeDrag) }

    @Deprecated
    void setUnk7(int unk7) { this.relativeDrag = IOUtil.intToBool(unk7) }

    @Deprecated
    int getUnk8() { IOUtil.boolToInt(superChild) }

    @Deprecated
    void setUnk8(int unk8) { this.superChild = IOUtil.intToBool(unk8) }

    @Deprecated
    boolean getAnchor() { usePosition }

    @Deprecated
    void setAnchor(boolean anchor) { this.usePosition = anchor }

    @Deprecated
    Alignment getAnchor_parent() { relativePoint }

    @Deprecated
    void setAnchor_parent(Alignment anchor_parent) { this.relativePoint = anchor_parent }

    @Deprecated
    Alignment getAnchor_this() { anchorPoint }

    @Deprecated
    void setAnchor_this(Alignment anchor_this) { this.anchorPoint = anchor_this }

    @Deprecated
    String getAnchor_ctrl() { relativeTo }

    @Deprecated
    void setAnchor_ctrl(String anchor_ctrl) { this.relativeTo = anchor_ctrl }

    @Deprecated
    String getText_font_1() { styleName }

    @Deprecated
    void setText_font_1(String text_font_1) { this.styleName = text_font_1 }

    @Deprecated
    String getText_font_2() { fontName }

    @Deprecated
    void setText_font_2(String text_font_2) { this.fontName = text_font_2 }

    @Deprecated
    Color getText_color() { fontColor }

    @Deprecated
    void setText_color(Color text_color) { this.fontColor = text_color }

    @Deprecated
    int getText_unk_const_zero() { fontLine.ordinal() }

    @Deprecated
    void setText_unk_const_zero(int text_unk_const_zero) { this.fontLine = FontLineType.valueOf(text_unk_const_zero) }

    @Deprecated
    int getUnk23() { IOUtil.boolToInt(virtual) }

    @Deprecated
    void setUnk23(int unk23) { this.virtual = IOUtil.intToBool(unk23) }

    @Deprecated
    String getPopupType() { tooltipType }

    @Deprecated
    void setPopupType(String popupType) { this.tooltipType = popupType }

    @Deprecated
    int getPopupValue() { tooltipText }

    @Deprecated
    void setPopupValue(int popupValue) { this.tooltipText = popupValue }

    @Deprecated
    int getUnk27() { tooltipAppearanceTime }

    @Deprecated
    void setUnk27(int unk27) { this.tooltipAppearanceTime = unk27 }

    @Deprecated
    int getUnk28() { scrollBarOffsetX }

    @Deprecated
    void setUnk28(int unk28) { this.scrollBarOffsetX = unk28 }

    @Deprecated
    int getUnk29() { scrollBarOffsetY }

    @Deprecated
    void setUnk29(int unk29) { this.scrollBarOffsetY = unk29 }

    @Deprecated
    int getUnk30() { scrollBarOffsetHeight }

    @Deprecated
    void setUnk30(int unk30) { this.scrollBarOffsetHeight = unk30 }
}
